...
function create() {
    ...
    // ボードを中央に配置
    const boardStartX = centerX - BOARD_PIXEL_SIZE / 2;
    const boardStartY = centerY - BOARD_PIXEL_SIZE / 2;
    ...
    // ボードを画像として追加（画面中央）
    this.add.image(boardStartX + BOARD_PIXEL_SIZE / 2, boardStartY + BOARD_PIXEL_SIZE / 2, 'boardTexture');
